...
export default class FormProperty {
  ...
  get colAttrs() {
    ...
    if (this._commonItemattrs == '1') {
      return { xs: 24, md: 24 }
    } else if (this._commonItemattrs == '2') {
      return { xs: 24, md: 12 }
    } else if (this._commonItemattrs == '3') {
      return { xs: 24, md: 8 }
    } else if (this._commonItemattrs == '4') {
      return { xs: 24, md: 6 }
    }
  ...
  get rules() {
    ...
    if (viewType === 'list' || viewType === 'radio' || viewType === 'markdown' || viewType === 'pca' || viewType.indexOf('sel') >= 0 || viewType === 'time') {
      return rules;
    }
