  ...
  <div class="properties-centent kk-checkbox">
    <div class="properties-body">
      ...
      <a-form v-show="selectItem.key !== ''">
        ...
        <!-- <a-form-item v-if="isDefined(options.subtable)" label="展示方式">
          <a-radio-group v-model="options.showType">
        ...
        <a-form-item v-if="isDefined(options.dic)" label="数据字典">
          <Radio buttonStyle="solid" v-model="options.dicDynamic">
            <RadioButton :value="1">静态</RadioButton>
            <RadioButton :value="2">字典</RadioButton>
            <RadioButton :value="3">表单</RadioButton>
          </Radio>
          <KChangeOption v-show="options.dicDynamic === 1" v-model="options.dicOptions" />
          <Input v-show="options.dicDynamic !== 1" v-model="options.dynamicKeyTable" placeholder="字典Table" />
          <Input v-show="options.dicDynamic === 3" v-model="options.dynamicKeyCode" placeholder="字典Code" />
          <Input v-show="options.dicDynamic === 3" v-model="options.dynamicKeyText" placeholder="字典Text" />

        </a-form-item>
        <!-- <a-form-item v-if="isDefined(options.dic)" label="选择模式">
          <a-radio-group v-model="options.multiple">
        ...
        <!--JUploadProperties-->
        <JUploadProperties :select-item="selectItem"></JUploadProperties>
        <!--JUploadKnowledgeProperties-->
        <JUploadKnowledgeProperties :select-item="selectItem"></JUploadKnowledgeProperties>
        <!--JImageUploadProperties-->
        <JImageUploadProperties :select-item="selectItem"></JImageUploadProperties>
        <!--JDictSelectTagProperties-->
        <JDictSelectTagProperties :select-item="selectItem"></JDictSelectTagProperties>
        <!--JMultiSelectTagProperties-->
        <JMultiSelectTagProperties :select-item="selectItem"></JMultiSelectTagProperties>
...
export default {
  ...
  methods: {
    ...
    filedShowChange() {
      ...
      //     filedList = []
      //   }
      //   filedList.push(row.code)

      // } else {
      //   filedList.filter(element => element !== row.code)
      // }
